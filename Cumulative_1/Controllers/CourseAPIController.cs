...
namespace Cumulative_1.Controllers
{
    ...
    public class CourseAPIController : ControllerBase
    {
        ...
        /// <summary>
        /// Updates any Course. Request query contains an ID, Data is Course object
        /// </summary>
        /// <param name="CourseData">Its the Course Object</param>
        /// <param name="CourseId">The Course ID consists of a primary key</param>
        /// <example>
